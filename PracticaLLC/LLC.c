...
void analizaARP(unsigned char t[]){
	//unsigned char HW[][12] = {"-","Ethernet", "-", "-", "-", "-", "IEEE 802", "-", "-", "-", "-", "-", "-", "-", "-", "Frame Relay", "ATM"};
	//unsigned char OP[][20] = {"-","ARP Request", "ARP Reply", "Inverse ARP Request", "Inverse ARP Reply", "-", "-", "-", "Inverse ARP Request", "Inverse ARP Reply"};

	printf("\n\n..:::Cabecera ARP:::..");
	//Hardware Address Type
	/*if(t[15]&1 || t[15]&6 || t[15]&15 || t[15]&16 ){
		printf("\n%s", HW[t[15]]);
	}else{
		printf("\n%.2x %.2x", t[15], t[16]);
	}*/
	...
	//IP Origen
	printf("\nIP Origen: %.2x:%.2x:%.2x:%.2x", t[28], t[29], t[30], t[31]);

	//MAC Destino
	printf("\nMAC Destino: %.2x:%.2x:%.2x:%.2x:%.2x:%.2x", t[32], t[33], t[34], t[35], t[36], t[37]);

	//IP Destino
	printf("\nIP Destino: %.2x:%.2x:%.2x:%.2x", t[38], t[39], t[40], t[41]);
